...
var AccessibleIcon = __name2(({ children, label }) => {
...
function createCollection(name) {
  ...
  const CollectionProvider = __name4((props) => {
  ...
  __name4(useCollection10, "useCollection");
  return [
...
__name4(createCollection, "createCollection");
...
}, _keys = new WeakMap(), __name4(_a, "OrderedDict"), _a);
...
__name4(toSafeIndex, "toSafeIndex");
function toSafeInteger(number) {
  return number !== number || number === 0 ? 0 : Math.trunc(number);
}
__name4(toSafeInteger, "toSafeInteger");
function createCollection2(name) {
  ...
  const CollectionProviderImpl = __name4((props) => {
  ...
  __name4(useInitCollection2, "useInitCollection");
  function useCollection10(scope) {
...
__name4(createCollection2, "createCollection");
...
__name4(shallowEqual, "shallowEqual");
function isElementPreceding(a, b) {
  return !!(b.compareDocumentPosition(a) & Node.DOCUMENT_POSITION_PRECEDING);
}
__name4(isElementPreceding, "isElementPreceding");
function sortByDocumentPosition(a, b) {
  return !a[1].element || !b[1].element ? 0 : isElementPreceding(a[1].element, b[1].element) ? -1 : 1;
}
__name4(sortByDocumentPosition, "sortByDocumentPosition");
...
__name4(getChildListObserver, "getChildListObserver");
...
__name6(useEffectEvent, "useEffectEvent");
...
var Collapsible = React10.forwardRef(
  __name10(function Collapsible2(props, forwardedRef) {
    const {
      __scopeCollapsible,
      open: openProp,
      defaultOpen,
...
var CollapsibleTrigger = React10.forwardRef(
  ...
  __name10(function CollapsibleTrigger2(props, forwardedRef) {
...
var CollapsibleContent = React10.forwardRef(
  // blank line to reduce diff noise
  __name10(function CollapsibleContent2(props, forwardedRef) {
...
var CollapsibleContentImpl = React10.forwardRef(__name10(function CollapsibleContentImpl2(props, forwardedRef) {
...
var Accordion = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function Accordion2(props, forwardedRef) {
...
var AccordionImplSingle = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function AccordionImplSingle2(props, forwardedRef) {
    const {
      value: valueProp,
      defaultValue,
      onValueChange = __name12(() => {
      }, "onValueChange"),
      collapsible = false,
...
var AccordionImplMultiple = React12.forwardRef(__name12(function AccordionImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name12(() => {
...
var AccordionImpl = React12.forwardRef(
  __name12(function AccordionImpl2(props, forwardedRef) {
    ...
    const handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
      ...
      const moveNext = __name12(() => {
        nextIndex = triggerIndex + 1;
        if (nextIndex > endIndex) {
          nextIndex = homeIndex;
        }
      }, "moveNext");
      const movePrev = __name12(() => {
        nextIndex = triggerIndex - 1;
...
var AccordionItem = React12.forwardRef(
  __name12(function AccordionItem2(props, forwardedRef) {
...
var AccordionHeader = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function AccordionHeader2(props, forwardedRef) {
...
var AccordionTrigger = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function AccordionTrigger2(props, forwardedRef) {
...
var AccordionContent = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function AccordionContent2(props, forwardedRef) {
...
var DismissableLayer = React14.forwardRef(
  // blank line to reduce diff noise
  __name14(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    React14.useEffect(() => {
      const handleUpdate = __name14(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React14.forwardRef(__name14(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React14.useContext(DismissableLayerContext);
...
var IS_TRUE = __name14(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React14.useEffect(() => {
    ...
    const handlePointerDown = __name14((event) => {
  ...
  return {
    ...
    onPointerDownCapture: __name14(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  ...
  React14.useEffect(() => {
    const handleFocus = __name14((event) => {
  ...
  return {
    onFocusCapture: __name14(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name14(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
...
var FocusScope = React15.forwardRef(
  __name15(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
...
var Portal = React16.forwardRef(
  __name16(function Portal2(props, forwardedRef) {
    ...
    return container ? ReactDOM.createPortal((0, import_jsx_runtime11.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
  }, "Portal")
);
var Root5 = Portal;
...
var Dialog = __name18((props) => {
  ...
  const [titleCount, setTitleCount] = React30.useState(0);
  const [descriptionCount, setDescriptionCount] = React30.useState(0);
...
var DialogTrigger = React30.forwardRef(
  __name18(function DialogTrigger2(props, forwardedRef) {
...
var DialogPortal = __name18((props) => {
  const { __scopeDialog, forceMount, children, container } = props;
  const context = useDialogContext(PORTAL_NAME, __scopeDialog);
  return (0, import_jsx_runtime12.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React30.Children.map(children, (child) => (0, import_jsx_runtime12.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime12.jsx)(Portal, { asChild: true, container, children: child }) })) });
}, "DialogPortal");
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React30.forwardRef(
  __name18(function DialogOverlay2(props, forwardedRef) {
...
var DialogOverlayImpl = React30.forwardRef(
  // blank line to reduce diff noise
  __name18(function DialogOverlayImpl2(props, forwardedRef) {
...
var DialogContent = React30.forwardRef(
  __name18(function DialogContent2(props, forwardedRef) {
...
var DialogContentModal = React30.forwardRef(
  // blank line to reduce diff noise
  __name18(function DialogContentModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME3, props.__scopeDialog);
    const contentRef = React30.useRef(null);
...
var DialogContentNonModal = React30.forwardRef(
  // blank line to reduce diff noise
  __name18(function DialogContentNonModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME3, props.__scopeDialog);
...
var DialogContentImpl = React30.forwardRef(
  // blank line to reduce diff noise
  __name18(function DialogContentImpl2(props, forwardedRef) {
    const { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus, ...contentProps } = props;
    const context = useDialogContext(CONTENT_NAME3, __scopeDialog);
    useFocusGuards();
    return (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: (0, import_jsx_runtime12.jsx)(
      FocusScope,
      {
        asChild: true,
        loop: true,
...
var DialogTitle = React30.forwardRef(
  __name18(function DialogTitle2(props, forwardedRef) {
...
var DialogDescription = React30.forwardRef(
  // blank line to reduce diff noise
  __name18(function DialogDescription2(props, forwardedRef) {
...
var DialogClose = React30.forwardRef(
  __name18(function DialogClose2(props, forwardedRef) {
...
var WarningProvider = __name18((props) => {
  return props.children;
}, "WarningProvider");
function getState3(open) {
  return open ? "open" : "closed";
}
__name18(getState3, "getState");
...
var AlertDialog = __name19((props) => {
  const { __scopeAlertDialog, ...alertDialogProps } = props;
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime13.jsx)(Dialog, { ...dialogScope, ...alertDialogProps, modal: true });
}, "AlertDialog");
var AlertDialogTrigger = React31.forwardRef(
  __name19(function AlertDialogTrigger2(props, forwardedRef) {
    const { __scopeAlertDialog, ...triggerProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime13.jsx)(DialogTrigger, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }, "AlertDialogTrigger")
);
var AlertDialogPortal = __name19((props) => {
  const { __scopeAlertDialog, ...portalProps } = props;
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime13.jsx)(DialogPortal, { ...dialogScope, ...portalProps });
}, "AlertDialogPortal");
var AlertDialogOverlay = React31.forwardRef(
  __name19(function AlertDialogOverlay2(props, forwardedRef) {
    const { __scopeAlertDialog, ...overlayProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime13.jsx)(DialogOverlay, { ...dialogScope, ...overlayProps, ref: forwardedRef });
  }, "AlertDialogOverlay")
);
...
var AlertDialogContent = React31.forwardRef(
  __name19(function AlertDialogContent2(props, forwardedRef) {
    const { __scopeAlertDialog, children, ...contentProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const contentRef = React31.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const cancelRef = React31.useRef(null);
    return (0, import_jsx_runtime13.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime13.jsx)(
      DialogContent,
      {
        role: "alertdialog",
        ...dialogScope,
...
var AlertDialogTitle = React31.forwardRef(
  __name19(function AlertDialogTitle2(props, forwardedRef) {
    const { __scopeAlertDialog, ...titleProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime13.jsx)(DialogTitle, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }, "AlertDialogTitle")
);
var AlertDialogDescription = React31.forwardRef(__name19(function AlertDialogDescription2(props, forwardedRef) {
  const { __scopeAlertDialog, ...descriptionProps } = props;
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime13.jsx)(DialogDescription, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
}, "AlertDialogDescription"));
var AlertDialogAction = React31.forwardRef(
  __name19(function AlertDialogAction2(props, forwardedRef) {
    const { __scopeAlertDialog, ...actionProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime13.jsx)(DialogClose, { ...dialogScope, ...actionProps, ref: forwardedRef });
  }, "AlertDialogAction")
);
var CANCEL_NAME = "AlertDialogCancel";
var AlertDialogCancel = React31.forwardRef(
  __name19(function AlertDialogCancel2(props, forwardedRef) {
    const { __scopeAlertDialog, ...cancelProps } = props;
    const { cancelRef } = useAlertDialogContentContext(CANCEL_NAME, __scopeAlertDialog);
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const ref = useComposedRefs(forwardedRef, cancelRef);
    return (0, import_jsx_runtime13.jsx)(DialogClose, { ...dialogScope, ...cancelProps, ref });
  }, "AlertDialogCancel")
);
...
var AspectRatio = React32.forwardRef(
  __name20(function AspectRatio2(props, forwardedRef) {
...
var Avatar = React33.forwardRef(
  // blank line to reduce diff noise
  __name21(function Avatar2(props, forwardedRef) {
...
var AvatarImage = React33.forwardRef(
  __name21(function AvatarImage2(props, forwardedRef) {
    ...
    const loadingStatusRef = React33.useRef(imageLoadingStatus);
    useLayoutEffect2(() => {
...
var AvatarFallback = React33.forwardRef(
  __name21(function AvatarFallback2(props, forwardedRef) {
...
function useImageLoadingStatus(src, {
  ...
  useLayoutEffect2(() => {
    ...
    const handleLoad = __name21((event) => {
      const image2 = event.currentTarget;
      setLoadingStatus(getImageLoadingStatus(image2));
    }, "handleLoad");
    const handleError = __name21(() => setLoadingStatus("error"), "handleError");
...
__name21(useImageCount, "useImageCount");
...
__name21(useUpdateImageCount, "useUpdateImageCount");
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React35.useState(null);
  const [bubbleInput, setBubbleInput] = React35.useState(null);
  const hasConsumerStoppedPropagationRef = React35.useRef(false);
  const [userInteractionCount, onUserInteraction] = React35.useReducer(
    (count3) => count3 + 1,
    0
  );
...
__name23(CheckboxProvider, "CheckboxProvider");
var TRIGGER_NAME4 = "CheckboxTrigger";
var CheckboxTrigger = React35.forwardRef(
  __name23(function CheckboxTrigger2({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) {
    const {
      control,
      value,
      disabled,
    ...
    const initialCheckedStateRef = React35.useRef(checked);
    React35.useEffect(() => {
      const form = control == null ? void 0 : control.form;
      if (form) {
        const reset = __name23(() => setChecked(initialCheckedStateRef.current), "reset");
...
var Checkbox = React35.forwardRef(
  // blank line to reduce diff noise
  __name23(function Checkbox2(props, forwardedRef) {
    const {
      __scopeCheckbox,
      name,
      checked,
...
var CheckboxIndicator = React35.forwardRef(
  // blank line to reduce diff noise
  __name23(function CheckboxIndicator2(props, forwardedRef) {
...
var CheckboxBubbleInput = React35.forwardRef(
  // blank line to reduce diff noise
  __name23(function CheckboxBubbleInput2({ __scopeCheckbox, onClick, ...props }, forwardedRef) {
    const {
      control,
      hasConsumerStoppedPropagationRef,
      userInteractionCount,
    ...
    const shouldStopClickPropagationRef = React35.useRef(false);
    const prevCheckedRef = React35.useRef(checked);
    const prevUserInteractionCountRef = React35.useRef(userInteractionCount);
    React35.useEffect(() => {
    ...
    const defaultCheckedRef = React35.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime16.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
__name23(isFunction2, "isFunction");
...
var Arrow = React37.forwardRef(
  __name24(function Arrow2(props, forwardedRef) {
...
var PopperAnchor = React38.forwardRef(
  __name25(function PopperAnchor2(props, forwardedRef) {
    ...
    return virtualRef ? null : (0, import_jsx_runtime18.jsx)(
      Primitive.div,
      {
...
var PopperContent = React38.forwardRef(
  __name25(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name25((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name25(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React38.forwardRef(
  __name25(function PopperArrow2(props, forwardedRef) {
...
__name25(isNotNull, "isNotNull");
var transformOrigin = __name25((options) => ({
...
__name25(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root25 = Popper;
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React39.useState(_isHydrated);
  React39.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name26(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React40.forwardRef(
  // blank line to reduce diff noise
  __name27(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React40.forwardRef(__name27(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React40.forwardRef(
  // blank line to reduce diff noise
  __name27(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name27(getDirectionAwareKey, "getDirectionAwareKey");
...
__name27(getFocusIntent, "getFocusIntent");
...
__name27(focusFirst2, "focusFirst");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name27(wrapArray, "wrapArray");
...
var Menu = __name28((props) => {
  ...
  const direction = useDirection(dir);
  React41.useEffect(() => {
    const handleKeyDown = __name28(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name28(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React41.useEffect(() => {
    ...
    const handleBlur = __name28(() => handleOpenChange(false), "handleBlur");
    window.addEventListener("blur", handleBlur);
    return () => window.removeEventListener("blur", handleBlur);
  }, [open, handleOpenChange]);
  return (0, import_jsx_runtime20.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime20.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuAnchor = React41.forwardRef(
  __name28(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React41.forwardRef(
  __name28(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React41.forwardRef(
  // blank line to reduce diff noise
  __name28(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
...
var MenuRootContentNonModal = React41.forwardRef(__name28(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
  return (0, import_jsx_runtime20.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React41.forwardRef(
  // blank line to reduce diff noise
  __name28(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name28((key) => {
      var _a2, _b;
      ...
      __name28(function updateSearch(value) {
...
var MenuGroup = React41.forwardRef(
  __name28(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React41.forwardRef(
  __name28(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React41.forwardRef(
  // blank line to reduce diff noise
  __name28(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React41.forwardRef(
  __name28(function MenuItemImpl2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime20.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime20.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime20.jsx)(
          Primitive.div,
          {
            role: "menuitem",
...
var MenuCheckboxItem = React41.forwardRef(
  // blank line to reduce diff noise
  __name28(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name28(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React41.forwardRef(
  __name28(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React41.forwardRef(
  __name28(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React41.forwardRef(
  // blank line to reduce diff noise
  __name28(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React41.forwardRef(
  __name28(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React41.forwardRef(
  __name28(function MenuArrow2(props, forwardedRef) {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime20.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "MenuArrow")
);
var SUB_NAME = "MenuSub";
var [MenuSubProvider, useMenuSubContext] = createMenuContext(SUB_NAME);
var MenuSub = __name28((props) => {
...
var MenuSubTrigger = React41.forwardRef(
  __name28(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React41.forwardRef(
  __name28(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext2(CONTENT_NAME6, props.__scopeMenu);
...
__name28(getOpenState, "getOpenState");
...
__name28(getCheckedState, "getCheckedState");
...
__name28(focusFirst3, "focusFirst");
function wrapArray2(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name28(wrapArray2, "wrapArray");
...
__name28(getNextMatch, "getNextMatch");
...
__name28(isPointInPolygon, "isPointInPolygon");
function isPointerInGraceArea(event, area) {
  if (!area) return false;
  const cursorPos = { x: event.clientX, y: event.clientY };
  return isPointInPolygon(cursorPos, area);
}
__name28(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name28(whenMouse, "whenMouse");
var Root32 = Menu;
...
var ContextMenu = __name29((props) => {
  const { __scopeContextMenu, children, onOpenChange, open: openProp, dir, modal = true } = props;
  const hasInteractedRef = React42.useRef(false);
  if (IS_DEVELOPMENT) {
    const hasWarnedRef = React42.useRef(false);
    React42.useEffect(() => {
  ...
  return (0, import_jsx_runtime21.jsx)(
    ContextMenuProvider,
    {
      ...
      modal,
      hasInteractedRef,
      children: (0, import_jsx_runtime21.jsx)(Root32, { ...menuScope, dir, open, onOpenChange: setOpen, modal, children })
    }
  );
}, "ContextMenu");
...
var ContextMenuTrigger = React42.forwardRef(
  // blank line to reduce diff noise
  __name29(function ContextMenuTrigger2(props, forwardedRef) {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME5, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const [point, setPoint] = React42.useState({ x: 0, y: 0 });
    const virtualRef = React42.useMemo(
      () => ({
        current: {
          getBoundingClientRect: __name29(() => DOMRect.fromRect({ width: 0, height: 0, ...point }), "getBoundingClientRect")
        }
      }),
      [point]
    );
    ...
    const handleOpen = __name29((event) => {
...
var ContextMenuPortal = __name29((props) => {
...
var ContextMenuContent = React42.forwardRef(
  // blank line to reduce diff noise
  __name29(function ContextMenuContent2(props, forwardedRef) {
...
var ContextMenuGroup = React42.forwardRef(
  // blank line to reduce diff noise
  __name29(function ContextMenuGroup2(props, forwardedRef) {
...
var ContextMenuLabel = React42.forwardRef(
  // blank line to reduce diff noise
  __name29(function ContextMenuLabel2(props, forwardedRef) {
...
var ContextMenuItem = React42.forwardRef(
  // blank line to reduce diff noise
  __name29(function ContextMenuItem2(props, forwardedRef) {
    const { __scopeContextMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime21.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "ContextMenuItem")
);
var ContextMenuCheckboxItem = React42.forwardRef(__name29(function ContextMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeContextMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime21.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "ContextMenuCheckboxItem"));
var ContextMenuRadioGroup = React42.forwardRef(__name29(function ContextMenuRadioGroup2(props, forwardedRef) {
  const { __scopeContextMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime21.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "ContextMenuRadioGroup"));
var ContextMenuRadioItem = React42.forwardRef(__name29(function ContextMenuRadioItem2(props, forwardedRef) {
  const { __scopeContextMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime21.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "ContextMenuRadioItem"));
var ContextMenuItemIndicator = React42.forwardRef(__name29(function ContextMenuItemIndicator2(props, forwardedRef) {
  const { __scopeContextMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime21.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "ContextMenuItemIndicator"));
var ContextMenuSeparator = React42.forwardRef(__name29(function ContextMenuSeparator2(props, forwardedRef) {
...
var ContextMenuArrow = React42.forwardRef(
  // blank line to reduce diff noise
  __name29(function ContextMenuArrow2(props, forwardedRef) {
...
var ContextMenuSub = __name29((props) => {
...
var ContextMenuSubTrigger = React42.forwardRef(__name29(function ContextMenuSubTrigger2(props, forwardedRef) {
  const { __scopeContextMenu, ...triggerItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime21.jsx)(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
}, "ContextMenuSubTrigger"));
var ContextMenuSubContent = React42.forwardRef(__name29(function ContextMenuSubContent2(props, forwardedRef) {
...
__name29(whenTouchOrPen, "whenTouchOrPen");
...
var DropdownMenu = __name30((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name30((props) => {
...
var DropdownMenuContent = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime22.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React43.forwardRef(__name30(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime22.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React43.forwardRef(__name30(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime22.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React43.forwardRef(__name30(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime22.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React43.forwardRef(__name30(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime22.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React43.forwardRef(__name30(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React43.forwardRef(
  // blank line to reduce diff noise
  __name30(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime22.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name30((props) => {
...
var DropdownMenuSubTrigger = React43.forwardRef(__name30(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime22.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React43.forwardRef(__name30(function DropdownMenuSubContent2(props, forwardedRef) {
...
var Form = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function Form2(props, forwardedRef) {
    const { __scopeForm, onClearServerErrors = __name31(() => {
    }, "onClearServerErrors"), ...rootProps } = props;
    const formRef = React44.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React44.useState({});
    const getFieldValidity = React44.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React44.useCallback(
    ...
    const handleFieldValiditionClear = React44.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React44.useState({});
    const getFieldCustomMatcherEntries = React44.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React44.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React44.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React44.useState({});
    const getFieldCustomErrors = React44.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React44.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React44.useState({});
    const handleFieldMessageIdAdd = React44.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React44.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React44.useCallback(
...
var FormField = React44.forwardRef(
  __name31(function FormField2(props, forwardedRef) {
...
var FormLabel = React44.forwardRef(
  __name31(function FormLabel2(props, forwardedRef) {
...
var FormControl = React44.forwardRef(
  __name31(function FormControl2(props, forwardedRef) {
    ...
    const updateControlValidity = React44.useCallback(
      async (control) => {
    ...
    React44.useEffect(() => {
      ...
      if (control) {
        const handleChange = __name31(() => updateControlValidity(control), "handleChange");
        control.addEventListener("change", handleChange);
        return () => control.removeEventListener("change", handleChange);
      }
    }, [updateControlValidity]);
    const resetControlValidity = React44.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React44.forwardRef(
  __name31(function FormMessage2(props, forwardedRef) {
...
var FormBuiltInMessage = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function FormBuiltInMessage2(props, forwardedRef) {
...
var FormCustomMessage = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function FormCustomMessage2(props, forwardedRef) {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React44.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React44.forwardRef(
  // blank line to reduce diff noise
  __name31(function FormMessageImpl2(props, forwardedRef) {
...
var FormValidityState = __name31((props) => {
...
var FormSubmit = React44.forwardRef(
  __name31(function FormSubmit2(props, forwardedRef) {
...
__name31(validityStateToObject, "validityStateToObject");
function isHTMLElement2(element) {
  return element instanceof HTMLElement;
}
__name31(isHTMLElement2, "isHTMLElement");
function isFormControl(element) {
  return "validity" in element;
}
__name31(isFormControl, "isFormControl");
...
__name31(getFirstInvalidControl, "getFirstInvalidControl");
function isAsyncCustomMatcherEntry(entry, args) {
  return entry.match.constructor.name === "AsyncFunction" || returnsPromise(entry.match, args);
}
__name31(isAsyncCustomMatcherEntry, "isAsyncCustomMatcherEntry");
function isSyncCustomMatcherEntry(entry) {
  return entry.match.constructor.name === "Function";
}
__name31(isSyncCustomMatcherEntry, "isSyncCustomMatcherEntry");
function returnsPromise(func, args) {
  return func(...args) instanceof Promise;
}
__name31(returnsPromise, "returnsPromise");
...
__name31(getInvalidAttribute, "getInvalidAttribute");
var Root9 = Form;
var Field = FormField;
...
var HoverCardTrigger = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function HoverCardTrigger2(props, forwardedRef) {
...
var HoverCardPortal = __name32((props) => {
...
var HoverCardContent = React45.forwardRef(
  // blank line to reduce diff noise
  __name32(function HoverCardContent2(props, forwardedRef) {
...
var HoverCardContentImpl = React45.forwardRef(__name32(function HoverCardContentImpl2(props, forwardedRef) {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  React45.useEffect(() => {
    if (ref.current) {
      const handlePointerUp = __name32(() => {
...
var HoverCardArrow = React45.forwardRef(
  __name32(function HoverCardArrow2(props, forwardedRef) {
    const { __scopeHoverCard, ...arrowProps } = props;
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime24.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "HoverCardArrow")
);
...
var Menubar = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function Menubar2(props, forwardedRef) {
    const {
      __scopeMenubar,
      value: valueProp,
      onValueChange,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React46.useState(null);
    return (0, import_jsx_runtime25.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React46.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React46.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React46.useCallback(
          (value2) => {
...
var MenubarMenu = __name33((props) => {
  ...
  const wasKeyboardTriggerOpenRef = React46.useRef(false);
...
var MenubarTrigger = React46.forwardRef(
  __name33(function MenubarTrigger2(props, forwardedRef) {
...
var MenubarPortal = __name33((props) => {
...
var MenubarContent = React46.forwardRef(
  __name33(function MenubarContent2(props, forwardedRef) {
...
var MenubarGroup = React46.forwardRef(
  __name33(function MenubarGroup2(props, forwardedRef) {
    const { __scopeMenubar, ...groupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime25.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }, "MenubarGroup")
);
var MenubarLabel = React46.forwardRef(
  __name33(function MenubarLabel2(props, forwardedRef) {
    const { __scopeMenubar, ...labelProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime25.jsx)(Label2, { ...menuScope, ...labelProps, ref: forwardedRef });
  }, "MenubarLabel")
);
var MenubarItem = React46.forwardRef(
  __name33(function MenubarItem2(props, forwardedRef) {
    const { __scopeMenubar, ...itemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime25.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "MenubarItem")
);
var MenubarCheckboxItem = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function MenubarCheckboxItem2(props, forwardedRef) {
    const { __scopeMenubar, ...checkboxItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime25.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
  }, "MenubarCheckboxItem")
);
var MenubarRadioGroup = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function MenubarRadioGroup2(props, forwardedRef) {
    const { __scopeMenubar, ...radioGroupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime25.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
  }, "MenubarRadioGroup")
);
var MenubarRadioItem = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function MenubarRadioItem2(props, forwardedRef) {
    const { __scopeMenubar, ...radioItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime25.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
  }, "MenubarRadioItem")
);
var MenubarItemIndicator = React46.forwardRef(__name33(function MenubarItemIndicator2(props, forwardedRef) {
  const { __scopeMenubar, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime25.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "MenubarItemIndicator"));
var MenubarSeparator = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function MenubarSeparator2(props, forwardedRef) {
    const { __scopeMenubar, ...separatorProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime25.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
  }, "MenubarSeparator")
);
var MenubarArrow = React46.forwardRef(
  __name33(function MenubarArrow2(props, forwardedRef) {
...
var MenubarSubTrigger = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function MenubarSubTrigger2(props, forwardedRef) {
...
var MenubarSubContent = React46.forwardRef(
  // blank line to reduce diff noise
  __name33(function MenubarSubContent2(props, forwardedRef) {
...
function usePrevious(value) {
  const ref = React47.useRef({ value, previous: value });
...
__name34(usePrevious, "usePrevious");
...
var NavigationMenu = React48.forwardRef(
  __name35(function NavigationMenu2(props, forwardedRef) {
    const {
...
var NavigationMenuSub = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function NavigationMenuSub2(props, forwardedRef) {
    const {
      __scopeNavigationMenu,
      value: valueProp,
      onValueChange,
...
var NavigationMenuProvider = __name35((props) => {
  const {
    scope,
    isRootMenu,
    rootNavigationMenu,
...
var NavigationMenuList = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function NavigationMenuList2(props, forwardedRef) {
...
var NavigationMenuItem = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function NavigationMenuItem2(props, forwardedRef) {
...
var NavigationMenuTrigger = React48.forwardRef(__name35(function NavigationMenuTrigger2(props, forwardedRef) {
...
var NavigationMenuLink = React48.forwardRef(
  // blank line to reduce diff noise
  __name35(function NavigationMenuLink2(props, forwardedRef) {
...
var NavigationMenuIndicator = React48.forwardRef(__name35(function NavigationMenuIndicator2(props, forwardedRef) {
...
var NavigationMenuIndicatorImpl = React48.forwardRef(__name35(function NavigationMenuIndicatorImpl2(props, forwardedRef) {
  ...
  const handlePositionChange = __name35(() => {
    if (activeTrigger) {
      setPosition({
...
var NavigationMenuContent = React48.forwardRef(__name35(function NavigationMenuContent2(props, forwardedRef) {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React48.forwardRef(__name35(function ViewportContentMounter2(props, forwardedRef) {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React48.forwardRef(__name35(function NavigationMenuContentImpl2(props, forwardedRef) {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
...
var NavigationMenuViewport = React48.forwardRef(__name35(function NavigationMenuViewport2(props, forwardedRef) {
...
var NavigationMenuViewportImpl = React48.forwardRef(__name35(function NavigationMenuViewportImpl2(props, forwardedRef) {
  ...
  const handleSizeChange = __name35(() => {
...
var NavigationMenuViewportItem = __name35(({
  contentRef,
  isActive,
  onActiveContentChange,
  ...props
}) => {
  const handleContentChange = React48.useCallback(
    (node) => {
      if (isActive && node) {
...
var FocusGroup = React48.forwardRef(
  __name35(function FocusGroup2(props, forwardedRef) {
...
var FocusGroupItem = React48.forwardRef(
  __name35(function FocusGroupItem2(props, forwardedRef) {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
__name35(getTabbableCandidates2, "getTabbableCandidates");
...
__name35(focusFirst4, "focusFirst");
...
__name35(removeFromTabOrder, "removeFromTabOrder");
...
__name35(useResizeObserver, "useResizeObserver");
function getOpenState2(open) {
  return open ? "open" : "closed";
}
__name35(getOpenState2, "getOpenState");
function makeTriggerId(baseId, value) {
  return `${baseId}-trigger-${value}`;
}
__name35(makeTriggerId, "makeTriggerId");
function makeContentId(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name35(makeContentId, "makeContentId");
function whenMouse2(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name35(whenMouse2, "whenMouse");
...
var OneTimePasswordField = React49.forwardRef(
  // blank line to reduce diff noise
  __name37(function OneTimePasswordFieldImpl({
    ...
    const latestValueRef = React49.useRef(value);
    latestValueRef.current = value;
    const dispatch = React49.useCallback(
      (action) => {
    ...
    React49.useEffect(() => {
      ...
      if (form2) {
        const reset = __name37(() => dispatch({ type: "CLEAR", reason: "Reset" }), "reset");
...
var OneTimePasswordFieldHiddenInput = React49.forwardRef(__name37(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React49.forwardRef(__name37(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
...
__name37(isFormElement, "isFormElement");
function removeWhitespace(value) {
  return value.replace(/\s/g, "");
}
__name37(removeWhitespace, "removeWhitespace");
...
__name37(focusInput, "focusInput");
function isInputEvent(event) {
  return event.type === "input";
}
__name37(isInputEvent, "isInputEvent");
...
var PasswordToggleField = __name38(({
...
var PasswordToggleFieldInput = React50.forwardRef(
  // blank line to reduce diff noise
  __name38(function PasswordToggleFieldInput2({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React50.forwardRef(
  // blank line to reduce diff noise
  __name38(function PasswordToggleFieldToggle2({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    onPointerCancel,
    ...
    React50.useEffect(() => {
      ...
      __name38(checkForInnerTextLabel, "checkForInnerTextLabel");
    ...
    React50.useEffect(() => {
      var _a2, _b;
      let cleanup = __name38(() => {
      }, "cleanup");
      const ownerWindow = ((_b = (_a2 = elementRef.current) == null ? void 0 : _a2.ownerDocument) == null ? void 0 : _b.defaultView) || window;
      const reset = __name38(() => focusState.current.clickTriggered = false, "reset");
      const handlePointerUp = __name38(() => cleanup = requestIdleCallback(ownerWindow, reset), "handlePointerUp");
...
var PasswordToggleFieldSlot = __name38(({
  __scopePasswordToggleField,
  ...props
}) => {
...
var PasswordToggleFieldIcon = React50.forwardRef(
  // blank line to reduce diff noise
  __name38(function PasswordToggleFieldIcon2({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...props
...
function requestIdleCallback(window2, callback, options) {
  ...
  const id = window2.setTimeout(() => {
    const timeRemaining = __name38(() => Math.max(0, 50 - (Date.now() - start)), "timeRemaining");
...
__name38(requestIdleCallback, "requestIdleCallback");
...
var PopoverAnchor = React51.forwardRef(
  __name39(function PopoverAnchor2(props, forwardedRef) {
...
var PopoverTrigger = React51.forwardRef(
  __name39(function PopoverTrigger2(props, forwardedRef) {
...
var PopoverPortal = __name39((props) => {
...
var PopoverContent = React51.forwardRef(
  // blank line to reduce diff noise
  __name39(function PopoverContent2(props, forwardedRef) {
...
var PopoverContentModal = React51.forwardRef(
  // blank line to reduce diff noise
  __name39(function PopoverContentModal2(props, forwardedRef) {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
...
var PopoverContentNonModal = React51.forwardRef(
  // blank line to reduce diff noise
  __name39(function PopoverContentNonModal2(props, forwardedRef) {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
...
var PopoverContentImpl = React51.forwardRef(
  // blank line to reduce diff noise
  __name39(function PopoverContentImpl2(props, forwardedRef) {
    const {
      __scopePopover,
      trapFocus,
      onOpenAutoFocus,
...
var PopoverClose = React51.forwardRef(
  __name39(function PopoverClose2(props, forwardedRef) {
...
var PopoverArrow = React51.forwardRef(
  __name39(function PopoverArrow2(props, forwardedRef) {
    const { __scopePopover, ...arrowProps } = props;
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime29.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "PopoverArrow")
);
function getState5(open) {
  return open ? "open" : "closed";
}
__name39(getState5, "getState");
var Root210 = Popover;
...
var Progress = React52.forwardRef(
  // blank line to reduce diff noise
  __name40(function Progress2(props, forwardedRef) {
    const {
      __scopeProgress,
...
var ProgressIndicator = React52.forwardRef(
  // blank line to reduce diff noise
  __name40(function ProgressIndicator2(props, forwardedRef) {
...
__name40(defaultGetValueLabel, "defaultGetValueLabel");
function getProgressState(value, maxValue) {
  return value == null ? "indeterminate" : value === maxValue ? "complete" : "loading";
}
__name40(getProgressState, "getProgressState");
function isNumber(value) {
  return typeof value === "number";
}
__name40(isNumber, "isNumber");
function isValidMaxNumber(max2) {
  return isNumber(max2) && !isNaN(max2) && max2 > 0;
}
__name40(isValidMaxNumber, "isValidMaxNumber");
function isValidValueNumber(value, max2) {
  return isNumber(value) && !isNaN(value) && value <= max2 && value >= 0;
}
__name40(isValidValueNumber, "isValidValueNumber");
function getInvalidMaxError(propValue, componentName) {
  return `Invalid prop \`max\` of value \`${propValue}\` supplied to \`${componentName}\`. Only numbers greater than 0 are valid max values. Defaulting to \`${DEFAULT_MAX}\`.`;
}
__name40(getInvalidMaxError, "getInvalidMaxError");
...
__name40(getInvalidValueError, "getInvalidValueError");
var Root10 = Progress;
...
function RadioProvider(props) {
  ...
  const [userInteractionCount, onUserInteraction] = React53.useReducer(
    (count3) => count3 + 1,
    0
  );
  const isFormControl2 = control ? !!form || !!control.closest("form") : (
  ...
  const context = {
    ...
    bubbleInput,
    setBubbleInput,
    onCheck: __name41(() => onCheck == null ? void 0 : onCheck(), "onCheck")
  };
  return (0, import_jsx_runtime31.jsx)(RadioProviderImpl, { scope: __scopeRadio, ...context, children: isFunction3(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
__name41(RadioProvider, "RadioProvider");
var TRIGGER_NAME11 = "RadioTrigger";
var RadioTrigger = React53.forwardRef(
  __name41(function RadioTrigger2({ __scopeRadio, onClick, ...radioProps }, forwardedRef) {
    const {
      checked,
      disabled,
      value,
...
var RadioIndicator = React53.forwardRef(
  __name41(function RadioIndicator2(props, forwardedRef) {
...
var RadioBubbleInput = React53.forwardRef(
  __name41(function RadioBubbleInput2({ __scopeRadio, onClick, ...props }, forwardedRef) {
    const {
      control,
      checked,
      required,
    ...
    const composedRefs = useComposedRefs(forwardedRef, setBubbleInput);
    const controlSize = useSize(control);
    const shouldStopClickPropagationRef = React53.useRef(false);
    const prevCheckedRef = React53.useRef(checked);
    const prevUserInteractionCountRef = React53.useRef(userInteractionCount);
    React53.useEffect(() => {
      const input = bubbleInput;
      if (!input) return;
      const inputProto = window.HTMLInputElement.prototype;
    ...
    const defaultCheckedRef = React53.useRef(checked);
    return (0, import_jsx_runtime31.jsx)(
      Primitive.input,
      {
        type: "radio",
...
__name41(isFunction3, "isFunction");
function getState6(checked) {
  return checked ? "checked" : "unchecked";
}
__name41(getState6, "getState");
...
var RadioGroup3 = React211.forwardRef(
  __name41(function RadioGroup24(props, forwardedRef) {
    const {
      __scopeRadioGroup,
      name,
      form,
    ...
    React211.useEffect(() => {
      ...
      if (associatedForm instanceof HTMLFormElement) {
        const reset = __name41(() => setValue(initialValueRef.current), "reset");
...
__name41(RadioGroupItemProvider, "RadioGroupItemProvider");
var RadioGroupItemTrigger = React211.forwardRef(__name41(function RadioGroupItemTrigger2(props, forwardedRef) {
  ...
  React211.useEffect(() => {
    const handleKeyDown = __name41((event) => {
      if (ARROW_KEYS2.includes(event.key)) {
        isArrowKeyPressedRef.current = true;
      }
    }, "handleKeyDown");
    const handleKeyUp = __name41(() => isArrowKeyPressedRef.current = false, "handleKeyUp");
...
var RadioGroupItem = React211.forwardRef(
  __name41(function RadioGroupItem2(props, forwardedRef) {
...
var RadioGroupItemBubbleInput = React211.forwardRef(__name41(function RadioGroupItemBubbleInput2(props, forwardedRef) {
...
var RadioGroupIndicator = React211.forwardRef(
  // blank line to reduce diff noise
  __name41(function RadioGroupIndicator2(props, forwardedRef) {
...
__name42(useStateMachine2, "useStateMachine");
var SCROLL_AREA_NAME = "ScrollArea";
var [createScrollAreaContext, createScrollAreaScope] = createContextScope(SCROLL_AREA_NAME);
var [ScrollAreaProvider, useScrollAreaContext] = createScrollAreaContext(SCROLL_AREA_NAME);
var ScrollArea = React212.forwardRef(
  __name42(function ScrollArea2(props, forwardedRef) {
    const {
      __scopeScrollArea,
      type = "hover",
      dir,
...
var ScrollAreaViewport = React212.forwardRef(
  // blank line to reduce diff noise
  __name42(function ScrollAreaViewport2(props, forwardedRef) {
...
var ScrollAreaViewportStyle = React212.memo(
  __name42(function ScrollAreaViewportStyle2({ nonce }) {
    return (0, import_jsx_runtime33.jsx)(
      "style",
      {
...
var ScrollAreaScrollbar = React212.forwardRef(
  // blank line to reduce diff noise
  __name42(function ScrollAreaScrollbar2(props, forwardedRef) {
...
var ScrollAreaScrollbarHover = React212.forwardRef(__name42(function ScrollAreaScrollbarHover2(props, forwardedRef) {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  ...
  React212.useEffect(() => {
    ...
    let hideTimer = 0;
    if (scrollArea) {
      const handlePointerEnter = __name42(() => {
        window.clearTimeout(hideTimer);
        setVisible(true);
      }, "handlePointerEnter");
      const handlePointerLeave = __name42(() => {
...
var ScrollAreaScrollbarScroll = React212.forwardRef(__name42(function ScrollAreaScrollbarScroll2(props, forwardedRef) {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarAuto = React212.forwardRef(__name42(function ScrollAreaScrollbarAuto2(props, forwardedRef) {
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const { forceMount, ...scrollbarProps } = props;
  const [visible, setVisible] = React212.useState(false);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarVisible = React212.forwardRef(__name42(function ScrollAreaScrollbarVisible2(props, forwardedRef) {
  ...
  const commonProps = {
    ...
    onThumbChange: __name42((thumb) => thumbRef.current = thumb, "onThumbChange"),
    onThumbPointerUp: __name42(() => pointerOffsetRef.current = 0, "onThumbPointerUp"),
    onThumbPointerDown: __name42((pointerPos) => pointerOffsetRef.current = pointerPos, "onThumbPointerDown")
  };
  function getScrollPosition(pointerPos, dir) {
    return getScrollPositionFromPointer(pointerPos, pointerOffsetRef.current, sizes, dir);
  }
  __name42(getScrollPosition, "getScrollPosition");
  if (orientation === "horizontal") {
    return (0, import_jsx_runtime33.jsx)(
...
var ScrollAreaScrollbarX = React212.forwardRef(__name42(function ScrollAreaScrollbarX2(props, forwardedRef) {
...
var ScrollAreaScrollbarY = React212.forwardRef(__name42(function ScrollAreaScrollbarY2(props, forwardedRef) {
  const { sizes, onSizesChange, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const [computedStyle, setComputedStyle] = React212.useState();
  const ref = React212.useRef(null);
...
var ScrollAreaScrollbarImpl = React212.forwardRef(__name42(function ScrollAreaScrollbarImpl2(props, forwardedRef) {
  const {
    __scopeScrollArea,
    sizes,
    hasThumb,
  ...
  __name42(handleDragScroll, "handleDragScroll");
  React212.useEffect(() => {
    const handleWheel = __name42((event) => {
...
var ScrollAreaThumb = React212.forwardRef(
  // blank line to reduce diff noise
  __name42(function ScrollAreaThumb2(props, forwardedRef) {
...
var ScrollAreaThumbImpl = React212.forwardRef(
  // blank line to reduce diff noise
  __name42(function ScrollAreaThumbImpl2(props, forwardedRef) {
...
var ScrollAreaCorner = React212.forwardRef(
  // blank line to reduce diff noise
  __name42(function ScrollAreaCorner2(props, forwardedRef) {
...
var ScrollAreaCornerImpl = React212.forwardRef(__name42(function ScrollAreaCornerImpl2(props, forwardedRef) {
...
__name42(toInt, "toInt");
function getThumbRatio(viewportSize, contentSize) {
  const ratio = viewportSize / contentSize;
  return isNaN(ratio) ? 0 : ratio;
}
__name42(getThumbRatio, "getThumbRatio");
...
__name42(getThumbSize, "getThumbSize");
...
__name42(getScrollPositionFromPointer, "getScrollPositionFromPointer");
...
__name42(getThumbOffsetFromScroll, "getThumbOffsetFromScroll");
...
__name42(linearScale, "linearScale");
function isScrollingWithinScrollbarBounds(scrollPos, maxScrollPos) {
  return scrollPos > 0 && scrollPos < maxScrollPos;
}
__name42(isScrollingWithinScrollbarBounds, "isScrollingWithinScrollbarBounds");
var addUnlinkedScrollListener = __name42((node, handler = () => {
}) => {
  let prevPosition = { left: node.scrollLeft, top: node.scrollTop };
  let rAF = 0;
  __name42(function loop() {
...
__name42(useDebounceCallback, "useDebounceCallback");
...
__name42(useResizeObserver2, "useResizeObserver");
...
function SelectProvider(props) {
  ...
  React55.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name43(() => setValue(initialValueRef.current), "reset");
      associatedForm.addEventListener("reset", reset);
      return () => associatedForm.removeEventListener("reset", reset);
    }
  ...
  const handleNativeOptionAdd = React55.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React55.useCallback((option) => {
...
__name43(SelectProvider, "SelectProvider");
var Select = __name43((props) => {
...
var SelectTrigger = React55.forwardRef(
  __name43(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name43((pointerEvent) => {
      if (!isDisabled) {
        context.onOpenChange(true);
        resetTypeahead();
      }
...
var SelectValue = React55.forwardRef(
  __name43(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime34.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime34.jsx)(React55.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React55.forwardRef(
  __name43(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name43((props) => {
...
var SelectContent = React55.forwardRef(
  __name43(function SelectContent2(props, forwardedRef) {
...
var SelectContentFragment = React55.forwardRef(__name43(function SelectContentFragment2(props, forwardedRef) {
...
var SelectContentImpl = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function SelectContentImpl2(props, forwardedRef) {
    ...
    React55.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name43((event) => {
          var _a2, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name43((event) => {
    ...
    React55.useEffect(() => {
      const close = __name43(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React55.forwardRef(__name43(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React55.forwardRef(__name43(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React55.forwardRef(
  __name43(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React55.forwardRef(
  __name43(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React55.forwardRef(
  __name43(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React55.forwardRef(
  __name43(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React55.forwardRef(
  __name43(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React55.forwardRef(__name43(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name43(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React55.forwardRef(__name43(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React55.forwardRef(__name43(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React55.forwardRef(
  __name43(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope4(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME2, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime34.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React55.forwardRef(
  // blank line to reduce diff noise
  __name43(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
...
__name43(isFunction4, "isFunction");
function shouldShowPlaceholder(value) {
  return value === "" || value === void 0;
}
__name43(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React55.useCallback(
    (key) => {
      ...
      __name43(function updateSearch(value) {
        searchRef.current = value;
        window.clearTimeout(timerRef.current);
        if (value !== "") timerRef.current = window.setTimeout(() => updateSearch(""), 1e3);
      }, "updateSearch")(search);
...
__name43(useTypeaheadSearch, "useTypeaheadSearch");
...
__name43(findNextItem, "findNextItem");
function wrapArray4(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name43(wrapArray4, "wrapArray");
...
var Separator3 = React56.forwardRef(
  __name44(function Separator24(props, forwardedRef) {
...
__name44(isValidOrientation, "isValidOrientation");
...
var Slider = React57.forwardRef(
  // blank line to reduce diff noise
  __name45(function Slider2(props, forwardedRef) {
    const {
      name,
      min: min2 = 0,
      max: max2 = 100,
      ...
      defaultValue = [min2],
      value,
      onValueChange = __name45(() => {
      }, "onValueChange"),
      onValueCommit = __name45(() => {
      }, "onValueCommit"),
      inverted = false,
      form,
      ...sliderProps
    ...
    const isKeyboardInteractionRef = React57.useRef(false);
    ...
    const initialValuesRef = React57.useRef(values);
    React57.useEffect(() => {
      const associatedForm = form ? control == null ? void 0 : control.ownerDocument.getElementById(form) : control == null ? void 0 : control.closest("form");
      if (associatedForm instanceof HTMLFormElement) {
        const reset = __name45(() => setValues(initialValuesRef.current), "reset");
        associatedForm.addEventListener("reset", reset);
        return () => associatedForm.removeEventListener("reset", reset);
      }
    ...
    __name45(handleSlideStart, "handleSlideStart");
    function handleSlideMove(value2) {
      updateValues(value2, valueIndexToChangeRef.current);
    }
    __name45(handleSlideMove, "handleSlideMove");
    function handleSlideEnd() {
      const hasChanged = String(values) !== String(valuesBeforeSlideStartRef.current);
      if (hasChanged) onValueCommit(values);
    }
    __name45(handleSlideEnd, "handleSlideEnd");
    ...
    __name45(updateValues, "updateValues");
...
var SliderHorizontal = React57.forwardRef(
  // blank line to reduce diff noise
  __name45(function SliderHorizontal2(props, forwardedRef) {
    const {
      min: min2,
      max: max2,
      dir,
    ...
    __name45(getValueFromPointer, "getValueFromPointer");
    return (0, import_jsx_runtime36.jsx)(
...
var SliderVertical = React57.forwardRef(
  __name45(function SliderVertical2(props, forwardedRef) {
    const {
      min: min2,
      max: max2,
      inverted,
...
var SliderImpl = React57.forwardRef(
  __name45(function SliderImpl2(props, forwardedRef) {
    const {
      __scopeSlider,
      onSlideStart,
      onSlideMove,
...
var SliderTrack = React57.forwardRef(
  __name45(function SliderTrack2(props, forwardedRef) {
...
var SliderRange = React57.forwardRef(
  __name45(function SliderRange2(props, forwardedRef) {
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction5(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
__name45(SliderThumbProvider, "SliderThumbProvider");
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React57.forwardRef(
  // blank line to reduce diff noise
  __name45(function SliderThumbTrigger2(props, forwardedRef) {
...
var SliderThumb = React57.forwardRef(
  __name45(function SliderThumb2(props, forwardedRef) {
...
var SliderBubbleInput = React57.forwardRef(
  // blank line to reduce diff noise
  __name45(function SliderBubbleInput2({ __scopeSlider, ...props }, forwardedRef) {
...
__name45(getNextSortedValues, "getNextSortedValues");
...
__name45(convertValueToPercentage, "convertValueToPercentage");
...
__name45(getClosestValueIndex, "getClosestValueIndex");
...
__name45(getThumbInBoundsOffset, "getThumbInBoundsOffset");
function getStepsBetweenValues(values) {
  return values.slice(0, -1).map((value, index2) => values[index2 + 1] - value);
}
__name45(getStepsBetweenValues, "getStepsBetweenValues");
...
__name45(hasMinStepsBetweenValues, "hasMinStepsBetweenValues");
...
__name45(linearScale2, "linearScale");
...
__name45(getDecimalCount, "getDecimalCount");
function roundValue(value, decimalCount) {
  const rounder = Math.pow(10, decimalCount);
  return Math.round(value * rounder) / rounder;
}
__name45(roundValue, "roundValue");
...
__name45(getNextStepValue, "getNextStepValue");
function isFunction5(value) {
  return typeof value === "function";
}
__name45(isFunction5, "isFunction");
...
function SwitchProvider(props) {
  ...
  const [userInteractionCount, onUserInteraction] = React58.useReducer(
    (count3) => count3 + 1,
    0
  );
  const isFormControl2 = control ? !!form || !!control.closest("form") : (
  ...
  return (0, import_jsx_runtime37.jsx)(SwitchProviderImpl, { scope: __scopeSwitch, ...context, children: isFunction6(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
__name46(SwitchProvider, "SwitchProvider");
var TRIGGER_NAME13 = "SwitchTrigger";
var SwitchTrigger = React58.forwardRef(
  __name46(function SwitchTrigger2({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) {
    const {
      control,
      form,
      value,
    ...
    React58.useEffect(() => {
      ...
      if (associatedForm instanceof HTMLFormElement) {
        const reset = __name46(() => setChecked(initialCheckedStateRef.current), "reset");
        associatedForm.addEventListener("reset", reset);
        return () => associatedForm.removeEventListener("reset", reset);
      }
...
var Switch = React58.forwardRef(
  // blank line to reduce diff noise
  __name46(function Switch2(props, forwardedRef) {
    const {
      __scopeSwitch,
      name,
      checked,
...
var SwitchThumb = React58.forwardRef(
  __name46(function SwitchThumb2(props, forwardedRef) {
...
var SwitchBubbleInput = React58.forwardRef(
  // blank line to reduce diff noise
  __name46(function SwitchBubbleInput2({ __scopeSwitch, onClick, ...props }, forwardedRef) {
    const {
      control,
      hasConsumerStoppedPropagationRef,
      userInteractionCount,
    ...
    const composedRefs = useComposedRefs(forwardedRef, setBubbleInput);
    const controlSize = useSize(control);
    const shouldStopClickPropagationRef = React58.useRef(false);
    const prevCheckedRef = React58.useRef(checked);
    const prevUserInteractionCountRef = React58.useRef(userInteractionCount);
    React58.useEffect(() => {
      const input = bubbleInput;
      if (!input) return;
      const inputProto = window.HTMLInputElement.prototype;
...
__name46(isFunction6, "isFunction");
function getState7(checked) {
  return checked ? "checked" : "unchecked";
}
__name46(getState7, "getState");
...
var Tabs = React59.forwardRef(
  // blank line to reduce diff noise
  __name47(function Tabs2(props, forwardedRef) {
    const {
      __scopeTabs,
      value: valueProp,
      onValueChange,
...
var TabsList = React59.forwardRef(
  // blank line to reduce diff noise
  __name47(function TabsList2(props, forwardedRef) {
...
var TabsTrigger = React59.forwardRef(
  __name47(function TabsTrigger2(props, forwardedRef) {
...
var TabsContent = React59.forwardRef(
  __name47(function TabsContent2(props, forwardedRef) {
...
__name47(makeTriggerId2, "makeTriggerId");
function makeContentId2(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name47(makeContentId2, "makeContentId");
var Root211 = Tabs;
var List2 = TabsList;
...
var ToastProvider = __name48((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React60.forwardRef(
  __name48(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React60.useEffect(() => {
      const handleKeyDown = __name48((event) => {
        var _a2;
    ...
    React60.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name48((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name48(() => {
...
var FocusProxy = React60.forwardRef(
  // blank line to reduce diff noise
  __name48(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React60.forwardRef(
  // blank line to reduce diff noise
  __name48(function Toast2(props, forwardedRef) {
...
var ToastImpl = React60.forwardRef(
  __name48(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
...
var ToastAnnounce = __name48((props) => {
...
var ToastTitle = React60.forwardRef(
  __name48(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React60.forwardRef(
  // blank line to reduce diff noise
  __name48(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React60.forwardRef(
  __name48(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React60.forwardRef(
  __name48(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React60.forwardRef(__name48(function ToastAnnounceExclude2(props, forwardedRef) {
...
__name48(getAnnounceTextContent, "getAnnounceTextContent");
...
__name48(handleAndDispatchCustomEvent2, "handleAndDispatchCustomEvent");
var isDeltaInDirection = __name48((delta, direction, threshold = 0) => {
...
__name48(useNextFrame, "useNextFrame");
function isHTMLElement3(node) {
  return node.nodeType === node.ELEMENT_NODE;
}
__name48(isHTMLElement3, "isHTMLElement");
function getTabbableCandidates3(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name48((node) => {
      const isHiddenInput = node.tagName === "INPUT" && node.type === "hidden";
      if (node.disabled || node.hidden || isHiddenInput) return NodeFilter.FILTER_SKIP;
      return node.tabIndex >= 0 ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
    }, "acceptNode")
...
__name48(getTabbableCandidates3, "getTabbableCandidates");
...
__name48(focusFirst5, "focusFirst");
...
var Toggle = React61.forwardRef(
  __name49(function Toggle2(props, forwardedRef) {
...
var ToggleGroup = React62.forwardRef(__name50(function ToggleGroup2(props, forwardedRef) {
...
var ToggleGroupImplSingle = React62.forwardRef(__name50(function ToggleGroupImplSingle2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name50(() => {
    }, "onValueChange"),
  ...
  return (0, import_jsx_runtime41.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      type: "single",
      value: React62.useMemo(() => value ? [value] : [], [value]),
      onItemActivate: setValue,
      onItemDeactivate: React62.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime41.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
}, "ToggleGroupImplSingle"));
var ToggleGroupImplMultiple = React62.forwardRef(__name50(function ToggleGroupImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name50(() => {
  ...
  const handleButtonActivate = React62.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React62.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime41.jsx)(
...
var ToggleGroupImpl = React62.forwardRef(
  // blank line to reduce diff noise
  __name50(function ToggleGroupImpl2(props, forwardedRef) {
    const {
      __scopeToggleGroup,
      disabled = false,
      rovingFocus = true,
...
var ToggleGroupItem = React62.forwardRef(
  // blank line to reduce diff noise
  __name50(function ToggleGroupItem2(props, forwardedRef) {
...
var ToggleGroupItemImpl = React62.forwardRef(
  // blank line to reduce diff noise
  __name50(function ToggleGroupItemImpl2(props, forwardedRef) {
...
var Toolbar = React63.forwardRef(
  // blank line to reduce diff noise
  __name51(function Toolbar2(props, forwardedRef) {
...
var ToolbarSeparator = React63.forwardRef(
  // blank line to reduce diff noise
  __name51(function ToolbarSeparator2(props, forwardedRef) {
...
var ToolbarButton = React63.forwardRef(
  __name51(function ToolbarButton2(props, forwardedRef) {
...
var ToolbarLink = React63.forwardRef(
  __name51(function ToolbarLink2(props, forwardedRef) {
...
var ToolbarToggleGroup = React63.forwardRef(
  // blank line to reduce diff noise
  __name51(function ToolbarToggleGroup2(props, forwardedRef) {
...
var ToolbarToggleItem = React63.forwardRef(
  // blank line to reduce diff noise
  __name51(function ToolbarToggleItem2(props, forwardedRef) {
...
var TooltipProvider = __name52((props) => {
  const {
    __scopeTooltip,
...
var Tooltip = __name52((props) => {
  ...
  const [contentIdState, setContentId] = React64.useState(void 0);
...
var TooltipTrigger = React64.forwardRef(
  __name52(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name52((props) => {
...
var TooltipContent = React64.forwardRef(
  __name52(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React64.forwardRef(__name52(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  ...
  React64.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name52((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name52((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React64.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name52((event) => {
        const target = event.target;
...
var TooltipContentImpl = React64.forwardRef(
  // blank line to reduce diff noise
  __name52(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
      "aria-label": ariaLabel,
    ...
    React64.useEffect(() => {
      if (context.trigger) {
        const handleScroll2 = __name52((event) => {
        ...
        children: (0, import_jsx_runtime43.jsxs)(
          Content3,
          {
            ...
            children: [
              ...
              ariaLabel ? (0, import_jsx_runtime43.jsx)(Root2, { id: context.contentId, role: "tooltip", children: ariaLabel }) : null
            ]
          }
        )
      }
...
var TooltipArrow = React64.forwardRef(
  __name52(function TooltipArrow2(props, forwardedRef) {
    const { __scopeTooltip, ...arrowProps } = props;
    const popperScope = usePopperScope5(__scopeTooltip);
    return (0, import_jsx_runtime43.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "TooltipArrow")
);
...
__name52(getExitSideFromRect, "getExitSideFromRect");
...
__name52(getPaddedExitPoints, "getPaddedExitPoints");
...
__name52(getPointsFromRect, "getPointsFromRect");
...
__name52(isPointInPolygon2, "isPointInPolygon");
...
__name52(getHullPresorted, "getHullPresorted");
